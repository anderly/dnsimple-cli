...
exports.init = function (cli) {
  ...
  cli.command('login')
    .description($('Log in to a dnsimple account. Currently, the user can login only via username/password or username/api-token'))
    ...
    .execute(function(options, _) {
      ...
      var supportedLoginTypeText = $('Please note that currently you can login only via username/password or username/api-token. ' +
