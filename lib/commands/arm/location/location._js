...
var knownLocations = require('./knownLocations');
...
exports.init = function (cli) {
  ...
  function buildResourceListWithLocation(allProviders) {
    ...
    //add a fixed location list for resource group
    var resourceGroupLocation = {
      name: $('Resource Group'),
      location: knownLocations.getValidLocationsOfResourceGroup().join(',')
    };
    allResources.push(resourceGroupLocation);
